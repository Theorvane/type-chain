...
This guide uses the published `@theorvane/type-chain@0.2.4` root surface to record explicit tool metadata and inspect immutable, receiver-bound definitions. TypeChain does not infer runtime schemas from TypeScript types or start a transport.
