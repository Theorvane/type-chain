# Getting started with @theorvane/type-chain@0.2.4
...
This guide installs the published package `@theorvane/type-chain@0.2.4`, configures Stage 3 decorators, and declares a first tool.
