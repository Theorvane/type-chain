...
> **Published version:** The examples target [`@theorvane/type-chain@0.2.3`](https://www.npmjs.com/package/@theorvane/type-chain). They use standard TypeScript decorators rather than legacy `experimentalDecorators`.
