...
This walkthrough uses one Petstore catalog tool to show the published [`@theorvane/type-chain@0.2.4`](https://www.npmjs.com/package/@theorvane/type-chain) flow: declare an explicit tool, optionally attach policy intent, then choose a LangChain, agent, or in-process TypeMCP boundary.
