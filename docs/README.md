...
TypeChain is a decorator-first authoring layer for typed LangChain JS tools and agents. The published package is [`@theorvane/type-chain@0.2.4`](https://www.npmjs.com/package/@theorvane/type-chain).
